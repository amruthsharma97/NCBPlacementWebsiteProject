...
namespace NCBPlacementWebsite.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        public async Task<ActionResult> RemoveUser(RemoveUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    var dresult = await UserManager.DeleteAsync(user);
                    ViewBag.remmsg = "User Removed Successfully!!!";
                    return View();
            ...
            ViewBag.remmsg = "Email Id Not Found!!!";
            return View(model);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (model.RoleName == "Student")
                    {
                        ...
                        return RedirectToAction("Create", "StudentProfiles",user);
            ...
            ViewBag.failure = "User Has Registered Already!!!";
